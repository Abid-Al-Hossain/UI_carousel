...
export default function Page() {
  const [state, setState] = useState<CarouselState>(DEFAULT_CAROUSEL_STATE);
  ...
  return <AppShell contentOverflow="hidden"><PlaygroundLayout title="Carousel Studio" controls={controls} preview={output} /></AppShell>;
}
