# UI Foundry Carousel Studio

Standalone visual Carousel generator built with Next.js, React, and TypeScript.

Standalone Carousel component studio for building native, preview-honest, React-exportable UI patterns that match the UI Foundry product line.
...
- designers building Carousel UI quickly
- developers who need editable React starting points
- marketplace buyers who want a self-contained Carousel generator
...
The editor is focused on controls that are native to Carousel and useful in real product work:
- slides, active index, arrows, dots, autoplay intent, loop, and item layout
- slide surface, gap, aspect ratio, radius, shadow, overlay, caption, and motion-safe transitions
- gallery, product, testimonial, hero, and card carousel archetypes
- region labels, button labels, and reduced-motion expectations
- React export for carousel composition

The goal is maximum useful depth without adding unrelated controls that would make the component stop reading as Carousel.
...
This repo is intended to publish as Abid-Al-Hossain/UI_carousel.
